...
function AirportBase() {
  ...
  return (
    <group position={[25, th + 0.3, 0]}>
      {/* Main hangar */}
      <mesh castShadow position={[0, 3, 0]}><boxGeometry args={[18, 6, 24]} /><meshStandardMaterial color="#7a7a7a" roughness={0.8} /></mesh>
      ...
      {/* Control tower */}
      <mesh castShadow position={[14, 5, -8]}><boxGeometry args={[5, 10, 5]} /><meshStandardMaterial color="#888888" roughness={0.7} /></mesh>
      ...
      {/* Small office */}
      <mesh castShadow position={[-8, 1.8, 18]}><boxGeometry args={[8, 3.5, 6]} /><meshStandardMaterial color="#8a7a6a" roughness={0.85} /></mesh>
      <mesh position={[-8, 3.8, 18]}><boxGeometry args={[8.5, 0.5, 6.5]} /><meshStandardMaterial color="#6a5a4a" roughness={0.9} /></mesh>
      {/* Fuel tanks */}
      <mesh castShadow position={[12, 1.5, 14]} rotation={[0, 0, Math.PI / 2]}><cylinderGeometry args={[1.5, 1.5, 5, 8]} /><meshStandardMaterial color="#cc4444" roughness={0.6} /></mesh>
      <mesh castShadow position={[12, 1.5, 18]} rotation={[0, 0, Math.PI / 2]}><cylinderGeometry args={[1.5, 1.5, 5, 8]} /><meshStandardMaterial color="#cccc44" roughness={0.6} /></mesh>
      {/* Windsock pole */}
